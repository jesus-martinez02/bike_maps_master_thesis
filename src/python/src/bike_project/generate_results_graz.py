...
for index,city in enumerate(city_list):
    ...
    df = pd.read_csv('/home/jmartinez/Documents/bike_project/Graz_zones.csv')
    ...
    network_reduction.calculate_edge_percentiles(conn, starting_seed = 0.4, edge_table = "temp_filtered_edges", selected_ods_table = "temp_selected_ods1",num_ods = NUM_ODS,
                                                 include_different_sensitivity = False,out_table = "results_graz_base_betweenness")
    ...
    network_reduction.calculate_edge_percentiles(conn, starting_seed = 0.4, edge_table = "temp_filtered_edges", selected_ods_table = "temp_selected_ods1",num_ods = NUM_ODS,
                                                 include_different_sensitivity = False,out_table = "results_graz_base_pois")
    ...
    network_reduction.calculate_edge_percentiles(conn, starting_seed = 0.4, edge_table = "temp_filtered_edges", selected_ods_table = "temp_selected_ods1",num_ods = NUM_ODS * 2,
                                                 include_different_sensitivity = False,out_table = "results_graz_base_non_random_des")
    ...
    network_reduction.calculate_edge_percentiles(conn, starting_seed = 0.4, edge_table = "temp_filtered_edges", selected_ods_table = "temp_selected_ods1",num_ods = NUM_ODS * 2,
                                                 include_different_sensitivity = False,out_table = "results_graz_base_dist")
    ...
    network_reduction.calculate_edge_percentiles(conn, starting_seed = 0.4, edge_table = "temp_filtered_edges", selected_ods_table = "temp_selected_ods1",num_ods = NUM_ODS * 2,
                                                 include_different_sensitivity = True,out_table = "results_graz_final")
