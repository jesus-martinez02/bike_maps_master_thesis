...
def categorise_residential(poi_building, city_center=None):
    ...
    # init residential
    poi_building['large_residential'] = 0
    poi_building['small_residential'] = 0
...
def categorise_activities(poi_building, poi_nonbuilding, city_center=None):
    ...
    # init categories
    poi_building['School'] = 0
    poi_building['Health'] = 0  # small and large
    poi_building['Leisure'] = 0  # indoor and outdoor, religious
    poi_building['Shops'] = 0  # food, other material
    poi_building['Services'] = 0  # public vs private
    poi_building['Industry'] = 0  # large vs small
    poi_building['Catering_industry'] = 0  # large vs small
    poi_building['Tourism'] = 0
    poi_building['Others'] = 0
    poi_building["Leisure_area"] = 0
